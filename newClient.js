...
app.post('/channels/query/init', function (req, res) {
    ...
    try{
        ...
        async function transactionCount(f){
            ...
            let peer = req.body.peer;
            let r = await query.queryChaincode(peer, channelName, chaincodeName, args, fcn, req.username, req.orgname);
            console.log("xxxxxxxxxxxxxxxxxxxxxxxxxx==========================",r,"****************************");
            currentCount++;
            f();
        }
        peerCount(callback);
