...
echo
curl -s -X POST \
  http://127.0.0.1:4000/channels/peers \
...
echo
curl -s -X POST \
  http://127.0.0.1:4000/chaincodes \
  -H "authorization: Bearer $Nxia_TOKEN" \
  -H "content-type: application/json" \
  -d '{
	"peers": ["peer1", "peer2"],
...
echo
curl -s -X POST \
  http://127.0.0.1:4000/channels/chaincodes \
  -H "authorization: Bearer $M_TOKEN" \
  -H "content-type: application/json" \
  -d '{
	"chaincodeName":"jiakechaincode",
...
echo
curl -s -X GET \
  "http://127.0.0.1:4000/channels/blocks/1?peer=peer1" \
  -H "authorization: Bearer $M_TOKEN" \
  -H "content-type: application/json"
echo
echo
...
echo
curl -s -X GET \
  "http://127.0.0.1:4000/channels?peer=peer1" \
  -H "authorization: Bearer $Nmen_TOKEN" \
  -H "content-type: application/json"
echo
echo
...
echo
curl -s -X GET \
  "http://127.0.0.1:4000/chaincodes?peer=peer1&type=installed" \
  -H "authorization: Bearer $Nxia_TOKEN" \
  -H "content-type: application/json"
echo
echo
...
echo
curl -s -X GET \
  "http://127.0.0.1:4000/chaincodes?peer=peer1&type=instantiated" \
  -H "authorization: Bearer $M_TOKEN" \
  -H "content-type: application/json"
echo
echo
