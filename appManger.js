...
app.post('/channels', function (req, res) {
	...
	var channelConfigPath = hfc.getConfigSetting('channelConfigPath'); //config path
...
app.put('/channels/chaincodes', function (req, res) {
	...
	upgrade.updateChaincode(chaincodeName, chaincodeVersion, req.username, req.orgname)
		.then(function (message) {
			if (message && typeof message !== 'string') {
				res.json(message);
			} else {
